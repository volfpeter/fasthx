...
- Instead of the `templates` argument of `TemplateHeader()`, you must use the `components` argument `ComponentHeader`, if you passed `templates` as a keyword argument.
